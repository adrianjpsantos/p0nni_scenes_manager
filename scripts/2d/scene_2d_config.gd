...
func set_player_position_on_exit(position: Vector2) -> void:
	_last_player_position = position

func set_player_rotation_on_exit(rotation: float) -> void:
...
func register_player_out(player:Node2D) -> void:
